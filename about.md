...
My PhD research focuses on improving data movement efficiency in large-scale distributed infrastructures through novel storage and networking abstractions. In practice that means designing operating-system and middleware mechanisms that optimize how data travels between distributed applications and storage tiers: zero-copy techniques, caching strategies, and kernel-level optimizations. I evaluate the prototypes on Linux platforms in the [Grid'5000](https://www.grid5000.fr) research data center.
